...
const CORE_AGENT_DEFINITIONS = [
  ...
  },
  {
    agentKey: "sales",
    name: "AI Sales",
    role: "Outreach, lead qualification, deal pipeline",
    capabilities: ["chat", "draft_outreach", "qualify_lead", "draft_email_sequence"],
    model: "deepseek",
    actionTypes: [
      {
        actionKey: "analyze_icp",
        label: "Analyze market & ICP",
        riskCategory: "read_only",
        defaultMode: "autonomous",
        adjustable: false,
        approverRule: "founder",
  ...
  },
  {
    agentKey: "mkt",
    name: "AI Marketing",
    role: "Content, campaigns, social media, organic growth",
    capabilities: ["chat", "create_social_post", "plan_campaign"],
    model: "deepseek",
    actionTypes: [
      {
        actionKey: "analyze_icp",
      ...
      {
        actionKey: "draft_email_sequence",
        label: "Draft email campaign sequence",
        riskCategory: "reversible",
        defaultMode: "autonomous",
        adjustable: true,
        approverRule: "founder",
