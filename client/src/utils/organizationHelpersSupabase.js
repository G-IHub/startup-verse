/**
 * Organization Helpers - BACKEND ONLY (Supabase)
 *
 * All organization operations now use the Supabase backend.
 * No localStorage fallback - everything is stored in the backend KV store.
 */

import * as orgApi from "./api/organizationApi";

console.log("🏢 Organization System: BACKEND MODE (Supabase)");
console.log("📡 All data stored in Supabase KV store");
...
export async function createOrganization(
  ...
  console.log("📤 Creating organization in Supabase...", { name, type });
...
export async function getUserOrganizations(userId) {
  console.log("📤 Fetching organizations from Supabase for user:", userId);
...
export async function getOrganization(orgId) {
  console.log("📤 Fetching organization from Supabase:", orgId);
...
export async function isOrganizationAdmin(userId, organizationId) {
  console.log("📤 Checking organization admin status in Supabase...", {
    userId,
    organizationId,
  });
...
export async function createCohort(
  ...
  console.log("📤 Creating cohort in Supabase...", { name, organizationId });
...
export async function getOrganizationCohorts(orgId) {
  console.log("📤 Fetching cohorts from Supabase for org:", orgId);
...
export async function deleteCohort(cohortId, userId) {
  console.log("📤 Deleting cohort from Supabase...", { cohortId, userId });
...
export async function getCohort(cohortId) {
  console.log("📤 Fetching cohort from Supabase:", cohortId);
...
export async function getFounderInvitations(founderId) {
  console.log("📤 Fetching invitations from Supabase for founder:", founderId);
...
export async function respondToInvitation(invitationId, founderId, status) {
  console.log("📤 Responding to invitation in Supabase...", {
    invitationId,
    status,
  });
...
export async function getCohortMembers(cohortId) {
  console.log("📤 Fetching cohort members from Supabase:", cohortId);
...
export async function getStartupSnapshot(founderId) {
  console.log("📤 Fetching startup snapshot from Supabase:", founderId);
...
export async function searchUserByEmail(email) {
  console.log(`🔍 Searching for founder in Supabase: ${email}`);
