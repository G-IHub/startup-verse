...
const panelClassName =
  "rounded-card border border-surface-border bg-surface-card shadow-soft transition-shadow duration-200 ease-in-out hover:shadow-card";
...
export default function FounderMetricsRow({
  ...
  return (
    <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
      <div className={cn(panelClassName, "flex items-center gap-3 p-4")}>
